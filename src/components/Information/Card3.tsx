    ...
    <div className="bg-white px-6 py-10 max-w-6xl mx-auto rounded-2xl shadow-lg mb-[60px] flex flex-col lg:flex-row gap-6">
      ...
      <div>
        <p className="text-black font-semibold">
          O Instituto Transformação é um exemplo inspirador de como uma iniciativa
          ...
          conhecido como Lagoinha Jiu-Jitsu, o Instituto oferece aulas gratuitas
