        ...
        <div className="flex flex-col-reverse lg:flex-row items-center justify-between max-w-7xl w-full gap-8 lg:gap-12">
          ...
          <div className="flex-1 max-w-md lg:max-w-lg xl:max-w-xl text-center lg:text-left px-4 lg:px-0">
            ...
            <p className="font-medium sm:font-semibold text-sm sm:text-base lg:text-lg leading-relaxed mb-6 sm:mb-8">
              A TURMA DE JIU-JITSU ADULTO MISTO É DIRECIONADA PARA HOMENS E
              MULHERES QUE BUSCAM APRIMORAR SUAS HABILIDADES NESTA ARTE MARCIAL
              E ALCANÇAR UM NÍVEL COMPETITIVO EXCEPCIONAL. NOSSAS AULAS MISTAS
              OFERECEM UMA PLATAFORMA ÚNICA PARA O DESENVOLVIMENTO DO JIU-JITSU
              DE ALTO NÍVEL, ONDE OS PARTICIPANTES TÊM A OPORTUNIDADE DE TREINAR
              EM CONJUNTO E COMPARTILHAR EXPERIÊNCIAS, PROMOVENDO UM AMBIENTE DE
              APRENDIZADO COLABORATIVO E ENRIQUECEDOR. ALÉM DISSO, TEMOS O
              COMPROMISSO DE OFERECER UM AMBIENTE INCLUSIVO. NOSSA METODOLOGIA É
              ADAPTADA PARA ATENDER ÀS NECESSIDADES DE ALUNOS COM DEFICIÊNCIA,
              GARANTINDO QUE TODOS TENHAM ACESSO IGUALITÁRIO AO APRENDIZADO E AO
