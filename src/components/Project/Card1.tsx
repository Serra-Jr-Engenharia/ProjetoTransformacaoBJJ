          ...
          <div className="flex flex-col-reverse lg:flex-row items-center justify-between max-w-7xl w-full gap-8 lg:gap-12">
            <div className="flex-1 max-w-md lg:max-w-lg xl:max-w-xl text-center lg:text-left px-4 lg:px-0">
              <p className="text-xs sm:text-sm font-semibold mb-2 lg:mb-3">
                Mais de 300 crianças matriculadas
              </p>
              ...
              <p className="font-medium sm:font-semibold text-sm sm:text-base lg:text-lg leading-relaxed mb-6 sm:mb-8">
                AS AULAS DE JIU-JITSU INFANTIL DO INSTITUTO TRANSFORMAÇÃO
                OFERECEM UMA EXPERIÊNCIA INCLUSIVA E ENRIQUECEDORA PARA CRIANÇAS
                DE TODAS AS IDADES E HABILIDADES. COM MAIS DE 80 CRIANÇAS
                MATRICULADAS ATUALMENTE, DIVIDIDAS EM DUAS TURMAS – INFANTIL 1,
                PARA CRIANÇAS ATÉ OS 9 ANOS, E INFANTIL 2, DE 10 A 14 ANOS – O
                PROGRAMA PRIORIZA O DESENVOLVIMENTO FÍSICO, EMOCIONAL E SOCIAL
                DOS ALUNOS. A METODOLOGIA APLICADA NAS AULAS É CUIDADOSAMENTE
                ADAPTADA PARA CADA FAIXA ETÁRIA, FOCANDO NA CONSTRUÇÃO DE
                HABILIDADES TÉCNICAS E ÉTICAS, ALÉM DE PROMOVER VALORES COMO
                RESPEITO, DISCIPLINA E TRABALHO EM EQUIPE. O INSTITUTO
                TRANSFORMAÇÃO TÊM SE DESTACADO PELO TREINAMENTO INCLUSIVO,
                ACOLHENDO ALUNOS COM NECESSIDADES ESPECIAIS, COMO AQUELES NO
                ESPECTRO AUTISTA (TEA) E ALUNOS COM SÍNDROME DE DOWN,
                PROPORCIONANDO-LHES UMA OPORTUNIDADE ÚNICA DE DESENVOLVIMENTO E
